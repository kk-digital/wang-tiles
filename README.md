...
Options:
  ...
  --generations <generations>                      (string) The number of iterations/generations for GA
  -?, -h, --help                                   Show help and usage information
```
Sample Command
```
./bin/Debug/net6.0/wang-tiles -- tiled-genetic-algo --version 1 --width 8 --height 8 --output-name "Tiled_Genetic_Algo_V1_8x8" --color-matching 1 --map-json-directory "./kcg-tiled/tilesets" --map-json-filename "Map_Tiles_V1.tmj" --crossover-probability 0.5 --mutation-probability 0.05 --population-size 100 --generations 1000
```
---
