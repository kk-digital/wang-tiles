...
{   
    public class ColorMap
    {
        ...
        //     PixelColors[31] = PixelColor.MakePixelColor(0,0,255, 250);
            ...
            CornerPixelColors[20] = PixelColor.MakePixelColor(0,0,205, 255);
            CornerPixelColors[21] = PixelColor.MakePixelColor(0,0,205, 255);
            CornerPixelColors[22] = PixelColor.MakePixelColor(0,0,205, 255);
            CornerPixelColors[23] = PixelColor.MakePixelColor(0,0,205, 255);
            CornerPixelColors[24] = PixelColor.MakePixelColor(0,0,205, 255);
            CornerPixelColors[25] = PixelColor.MakePixelColor(0,0,205, 255);
